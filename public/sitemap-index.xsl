...
<head>
  ...
  <title>Sitemap Index — Electrician Audit</title>
  <style>
    *{margin:0;box-sizing:border-box}
    ...
    .ct{color:#f59e0b}
    .list{display:flex;flex-direction:column;gap:1px;border:1px solid #1e293b;border-radius:2px;overflow:hidden}
    .row{display:flex;align-items:center;justify-content:space-between;padding:1.25rem 1.5rem;background:#111827}
    .row:hover{background:#1e293b}
    a{color:#f59e0b;text-decoration:none;font-size:.875rem;font-weight:500}
