/**
 * Market Data Sync — Aggregates electrician audit data for market pages.
 *
...
const GAP_MAP = {
  // ── Electrician-specific gaps ──────────────────────────────────────
  "No before/after gallery or project photos": {
    slug: "no-before-after-gallery",
    display: "No Before/After Gallery",
    category: "trust",
  },
  "No warranty information page": {
    slug: "no-warranty-page",
    display: "No Warranty Information Page",
    category: "content",
  },
  "No same-day / rapid response messaging for emergencies": {
    slug: "no-rapid-response",
    display: "No Rapid Response Messaging",
    category: "competitive",
  },
  "No ElectricalContractor or LocalBusiness schema markup": {
  ...
  "No licensing or certifications displayed": {
    ...
    display: "No Licensing/Certifications Displayed",
    category: "trust",
  },
  "No electrical safety tips or educational content": {
    slug: "no-safety-content",
    display: "No Electrical Safety Content",
    category: "content",
  },
  "No emergency electrical services page": {
    slug: "no-emergency-services-page",
    display: "No Emergency Services Page",
    category: "lead-capture",
  },
  "No dedicated panel upgrade page": {
    slug: "no-panel-upgrade-page",
    display: "No Panel Upgrade Page",
    category: "content",
  },
  "No EV charger installation page": {
    slug: "no-ev-charger-page",
    display: "No EV Charger Installation Page",
    category: "content",
  },
  "No generator installation page": {
    slug: "no-generator-page",
    display: "No Generator Installation Page",
    category: "content",
  },
  "No energy-efficiency or solar-ready content": {
    slug: "no-solar-content",
    display: "No Solar/Energy-Efficiency Content",
    category: "content",
  },
  "No whole-home rewiring page": {
    slug: "no-rewiring-page",
    display: "No Whole-Home Rewiring Page",
    category: "content",
  },
  "No lighting installation page": {
    slug: "no-lighting-page",
    display: "No Lighting Installation Page",
    category: "content",
  },
  "No surge protection page": {
    slug: "no-surge-protection-page",
    display: "No Surge Protection Page",
    category: "content",
  },
  "No electrical inspection page": {
    slug: "no-inspection-page",
    display: "No Electrical Inspection Page",
    category: "content",
  },
  "No \"signs you need an electrician\" educational content": {
    slug: "no-signs-content",
    display: "No Warning Signs Content",
    category: "content",
  },
  "No \"how much does electrical work cost\" content": {
    slug: "no-cost-content",
    display: "No Electrical Cost Content",
    category: "content",
  },
  "No code compliance content": {
    slug: "no-code-content",
    display: "No Electrical Code Content",
    category: "content",
  },
  ...
  "No smoke detector / CO detector page": {
    slug: "no-detector-page",
    display: "No Smoke/CO Detector Page",
    category: "content",
  },
  "No ceiling fan installation page": {
    slug: "no-ceiling-fan-page",
    display: "No Ceiling Fan Installation Page",
    category: "content",
  },
  "No outlet/switch installation page": {
    slug: "no-outlet-page",
    display: "No Outlet/Switch Installation Page",
    category: "content",
  },
  "No dedicated residential services page": {
    slug: "no-residential-page",
    display: "No Residential Services Page",
    category: "content",
  },
  // ── Shared gaps ────────────────────────────────────────────────────
  ...
  "No recurring maintenance plan framing": {
    slug: "no-recurring-plan",
    display: "No Recurring Maintenance Plan Framing",
    category: "content",
  },
  "No commercial services page": {
    slug: "no-commercial-page",
    display: "No Commercial Services Page",
    category: "content",
  },
  "No dedicated panel upgrade page": {
    slug: "no-panel-upgrade-page",
    display: "No Dedicated Panel Upgrade Page",
    category: "content",
  },
...
async function main() {
  ...
  // ─── Pull all electrician leads with enrichment + deep audit ──────
  const res = await client.query(`
    SELECT
      ...
      niche_audit
    FROM leads
    WHERE category = 'electrician' AND city IS NOT NULL AND state IS NOT NULL
  `);
  const allLeads = res.rows;
  console.log(`Fetched ${allLeads.length} electrician leads with city/state.`);
  ...
  const output = {
    ...
    service: "electrical",
    indexName: "Electrician Website Index",
    national: {
      service: "electrical",
      ...nationalStats,
